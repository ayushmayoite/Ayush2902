...
"[project]/lib/getProducts.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getProducts() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").order("name", {
        ascending: true
    });
    if (error) {
...
async function getProductsByCategory(categoryId) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").eq("category", categoryId).order("name", {
        ascending: true
    });
    if (error) {
...
async function getProductBySlug(slug) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").eq("slug", slug).single();
    if (error) {
...
async function getCatalog() {
    ...
    const [catRes, prodRes] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("*"),
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").order("name", {
            ascending: true
        })
    ]);
    if (catRes.error) {
...
async function getCategoryIds() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("products").select("category").order("category");
    if (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/getProducts.ts [app-client] (ecmascript)");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            async function loadNav() {
                try {
                    const catalog = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCatalog"])();
                    const mapped = catalog.map({
                        "Header.useEffect.loadNav.mapped": (cat)=>({
                                label: cat.name,
                                href: `/products/${cat.id}`
                            })
                    }["Header.useEffect.loadNav.mapped"]);
...
_s(Header, "Hv7TibQM1JC6M+kUNYp14E2RMFs=");
_c = Header;
var _c;
...
//# sourceMappingURL=_453c0bc7._.js.map