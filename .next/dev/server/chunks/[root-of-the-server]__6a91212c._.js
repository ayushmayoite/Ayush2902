...
;
async function GET() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("categories").select("id, name").order("name", {
        ascending: true
    });
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a91212c._.js.map